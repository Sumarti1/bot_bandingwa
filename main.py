...
# ✅ GAMBAR DARI SUMBER TIDAK DIBLOKIR
FOTO_URL = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Telegram_logo.svg/512px-Telegram_logo.svg.png"
...
def kirim_pesan(chat_id, teks, tombol=None):
    try:
        ...
        # Kalau gambar tetap gagal, kirim teks saja yang rapi
    ...
    for host, port, tipe in server_list:
        try:
            bot.edit_message_caption(id_user, pesan.message_id,
                f"⏳ **PROSES PENGIRIMAN**\n✅ Langkah 1: Data siap\n🔹 Langkah 2: Hubung `{host}:{port}`...", parse_mode="Markdown")
            time.sleep(1)
            ...
            bot.edit_message_caption(id_user, pesan.message_id,
                "⏳ **PROSES PENGIRIMAN**\n✅ Langkah 1: Data siap\n✅ Langkah 2: Terhubung server\n🔹 Langkah 3: Verifikasi akun Gmail...", parse_mode="Markdown")
            time.sleep(1)
