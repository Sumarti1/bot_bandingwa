...
MAKSIMAL_GMAIL = 15
BATAS_WAKTU_BALAS = 120  # 2 Menit = dianggap gagal
...
def pantau_balasan():
    while True:
        ...
        for gmail_data in akun:
            try:
                koneksi = imaplib.IMAP4_SSL("imap.gmail.com", 993)
...
💡 Menunggu balasan dari WhatsApp
            ...
            print(f"[KIRIM EMAIL] {e}")
            kirim_pesan(id_pengguna, "❌ Gagal kirim! Cek sandi aplikasi / verifikasi 2 langkah", menu_utama())
        del proses[id_pengguna]
