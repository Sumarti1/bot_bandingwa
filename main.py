...
# ✅ LINK GAMBAR LANGSUNG (AKHIRAN .PNG, DITERIMA TELEGRAM)
LINK_GAMBAR = "https://i.ibb.co/9t2kGpY/asepkanjut.png"
NAMA_FILE_GAMBAR = "asepkanjut.png"

# ==================== DOWNLOAD GAMBAR OTOMATIS ✅ ====================
if not os.path.exists(NAMA_FILE_GAMBAR):
    try:
        print("📥 Sedang unduh gambar tampilan...")
        res = requests.get(LINK_GAMBAR, timeout=30)
        if res.status_code == 200:
            with open(NAMA_FILE_GAMBAR, "wb") as f:
                f.write(res.content)
            print("✅ Gambar tampilan siap dipakai!")
        else:
            print("⚠️ Gagal unduh gambar, pakai teks saja")
    except Exception as e:
        print(f"⚠️ Gambar gagal diunduh: {e}")
...
# ==================== FUNGSI PESAN ✅ PASTI MUNCUL GAMBAR ====================
def kirim_pesan(chat_id, teks, tombol=None):
    try:
        # Kirim file gambar yang sudah diunduh (bukan link!)
...
if __name__ == "__main__":
    print("🚀 BOT SIAP! GAMBAR DIPAKAI LANGSUNG DARI FILE")
    while True:
