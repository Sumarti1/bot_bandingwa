...
# ✅ Dideklarasikan di awal biar tidak error
indeks_gmail = 0
...
def kirim_email_proses(id_user, pengirim, sandi, tujuan, isi, subjek):
    ...
    bot.edit_message_caption(id_user, pesan.message_id,
        "❌ **SEMUA JALUR GAGAL**\nRailway blokir port email, pindah ke Render/Termux ya!", parse_mode="Markdown", reply_markup=menu_utama(id_user))
    return False
