...
# ✅ LINK FOTO AMAN TERBACA TELEGRAM (PASTI MUNCUL)
...
# ==================== FUNGSI PESAN ✅ SELALU TAMPILKAN FOTO ====================
def kirim_pesan(chat_id, teks, tombol=None):
    try:
        # INI YANG MEMUNCULKAN FOTO DI ATAS SEMUA PESAN
        bot.send_photo(
            chat_id=chat_id,
            photo=FOTO_URL,
            caption=teks,
...
if __name__ == "__main__":
    print("🚀 BOT SIAP! FOTO MUNCUL DI SEMUA PESAN")
    while True:
