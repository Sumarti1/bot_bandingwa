...
# 🖼️ BRANDING - PASTI MUNCUL DARI LINK GITHUB
...
# -------------------- FUNGSI KIRIM PESAN DENGAN FOTO SELALU ADA --------------------
def kirim_pesan(chat_id, teks, tombol=None):
    try:
        # Kirim selalu pakai foto lewat link
        bot.send_photo(
            chat_id=chat_id,
            photo=FOTO_URL,
            caption=teks,
        ...
        # Cadangan kalau ada gangguan, tetap kirim tulisan
        try:
            bot.send_message(
                chat_id=chat_id,
                text=teks,
