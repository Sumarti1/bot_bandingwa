...
# ✅ FOTO KAMU LANGSUNG DARI GITHUB (TIDAK AKAN HILANG LAGI!)
FOTO_URL = "https://raw.githubusercontent.com/Suma/bot_bandingwa/main/1782676789784.png"
...
if __name__ == "__main__":
    print("🚀 BOT SIAP! FOTO DARI GITHUB KAMU.")
    while True:
