...
# 🖼️ BRANDING - SUDAH DIPERBAIKI JALUR FOTO
...
# -------------------- FUNGSI KIRIM PESAN DENGAN FOTO --------------------
def kirim_pesan(chat_id, teks, tombol=None):
    try:
        # Cek apakah file foto ada, jika ada kirim dengan foto
        if os.path.exists(FOTO_PATH):
            ...
            # Jika tidak ketemu foto, tetap kirim tulisan saja biar tidak error
            bot.send_message(
                chat_id,
                teks,
                reply_markup=tombol,
